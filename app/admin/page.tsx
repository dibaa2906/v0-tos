...
export default function AdminOverviewPage() {
  ...
  const [activeTab, setActiveTab] = useState<'mine' | 'all' | 'leaves'>('mine')
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setStats({
        ...
        lateToday: reportsData.totals?.totalLate || 0,
        absentToday: reportsData.totals?.totalAbsent || 0,
        onTimeToday: reportsData.totals?.totalOnTime || 0
      })
    ...
    <AdminGuard>
      <AdminLayout>
        <div className="space-y-6">
          {/* Hero Section */}
          <div className="bg-gradient-to-r from-[#40e0d0] to-[#20b2aa] rounded-lg p-8 text-white">
          ...
          {myDepartment && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-[#20b2aa]/40 hover:shadow-md transition cursor-pointer" onClick={() => router.push('/admin/interns?view=mine')}>
              ...
              <Card className="border-[#20b2aa]/40">
                ...
                <CardContent className="flex flex-wrap gap-2">
                  <Button size="sm" variant="outline" className="border-white text-[#20b2aa]" onClick={() => router.push('/admin/interns?view=mine')}>
                    Manage My Interns
                  </Button>
                  <Button size="sm" variant="outline" className="border-white text-[#20b2aa]" onClick={() => router.push('/admin/leaves')}>
                    Review Leaves
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="border-[#40e0d0]/30 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => router.push('/admin/interns?view=all')}>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-medium text-gray-600">Total Interns</CardTitle>
                  <div className="h-10 w-10 rounded-full bg-[#40e0d0]/10 flex items-center justify-center">
            ...
            <Card className="border-[#40e0d0]/30 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => router.push('/admin/interns')}>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
              ...
              <CardContent>
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="mt-4 text-[#20b2aa] hover:text-[#1a9b94] hover:bg-[#40e0d0]/10 w-full justify-between"
            ...
            <Card className="border-[#40e0d0]/30 hover:shadow-lg transition-shadow cursor-pointer" onClick={() => router.push('/admin/attendance/stats')}>
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
              ...
              <CardContent>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="w-full justify-between text-[#20b2aa] hover:text-[#1a9b94] hover:bg-[#40e0d0]/10"
                        ...
                        {allInterns.slice(0, 8).map(intern => (
                          ...
                          >
                            ...
                            <td className="p-4 text-right">
                              <Badge className={intern.isActive !== 0 && intern.isActive !== false ? 'bg-[#20b2aa] text-white' : 'bg-gray-200 text-gray-700'}>
                                {intern.isActive !== 0 && intern.isActive !== false ? 'Active' : 'Inactive'}
                              </Badge>
                            </td>
                          </tr>
