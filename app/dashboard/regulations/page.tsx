    ...
    if (!isLoginRedirect) {
      try {
        if (checkDirectAccess()) {
          console.log('[RegulationsPage] Direct access detected, redirecting to login')
        ...
        <div className="flex-1 min-h-0 overflow-y-auto mb-4 pr-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="border-[#40e0d0]/30 hover:shadow-md transition-shadow">
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="h-10 w-10 rounded-lg bg-[#20b2aa]/10 flex items-center justify-center flex-shrink-0">
